...
BOOST_FIXTURE_TEST_CASE(rpc_scrapes, RPCServerFixture)
{
    ...
    string strValidAddress = "dNsgxYgHwfWexm64z3E8ZRzKembpcKmG7v";
    string strValidPrivKey = "ZHbcuy4b9z7R3FAwvsmNfHoG3LtrfoCPtoYWhUG4thypZySos2ti";
    string strValidAddress2 = "dbrxGK62DXSJ6Cm3zgurPs3ML9uKxfwv5Z";
    ...
    strParams.clear();
    strParams.push_back("dNsgxYgHwfWe");
    strParams.push_back("dbrxGK62DXSJ");
